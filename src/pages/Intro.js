        ...
        <body>
            <div className='intro'>
                <div className='intro0'>
                    <Bounce left cascade>
                        <div className='title'>
                            <p>여러분만의 포트폴리오를<br/>(사이트)에서 만들어보세요!</p>
                        </div>
                    </Bounce>
                    <div className='intro0_text'>
                        <p> 다양한 템플릿을 이용하여 간편하게 만들어보세요<br/>
                        주어진 양식대로 입력하면 코딩을 몰라도 나만의 포트폴리오를 무료로 제작할 수 있습니다.</p>
                    </div>
                ...
                <div className="intro1">
                    <Flip left>
                        <div className="intro1_text">
                            <p>우리 (사이트)로 제작한 <br/> 다양한 포트폴리오를 확인해보세요! <br/>
                            관심분야의 포트폴리오를 쉽게 조회할 수 있습니다.</p>
